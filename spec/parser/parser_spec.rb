...
describe Parser do
  ...
  it_parses "def foo(a, &block : Int -> Double); end", Def.new("foo", [Arg.new("a")], nil, nil, BlockArg.new("block", FunTypeSpec.new(["Int".ident], "Double".ident)), 1)
  it_parses "def foo(a, &block : Int, Float -> Double); end", Def.new("foo", [Arg.new("a")], nil, nil, BlockArg.new("block", FunTypeSpec.new(["Int".ident, "Float".ident], "Double".ident)), 2)
  ...
  it_parses "struct Foo::Bar; end", StructDef.new(Ident.new(["Foo", "Bar"]))
  ...
  it_parses "lib C\nfun getchar(...)\nend", LibDef.new('C', nil, [FunDef.new('getchar', [], nil, true)])
  ...
  it_parses "lib C; struct Foo; end end", LibDef.new('C', nil, [CStructDef.new('Foo')])
  it_parses "lib C; struct Foo; x : Int; y : Float; end end", LibDef.new('C', nil, [CStructDef.new('Foo', [Arg.new('x', nil, 'Int'.ident), Arg.new('y', nil, 'Float'.ident)])])
  it_parses "lib C; struct Foo; x : Int*; end end", LibDef.new('C', nil, [CStructDef.new('Foo', [Arg.new('x', nil, 'Int'.ident.pointer_of)])])
  it_parses "lib C; struct Foo; x : Int**; end end", LibDef.new('C', nil, [CStructDef.new('Foo', [Arg.new('x', nil, 'Int'.ident.pointer_of.pointer_of)])])
  it_parses "lib C; struct Foo; x : B, C -> D; end; end", LibDef.new('C', nil, [CStructDef.new('Foo', [Arg.new('x', nil, FunTypeSpec.new(["B".ident, "C".ident], "D".ident))])])
  it_parses "lib C; struct Foo; x, y, z : Int; end end", LibDef.new('C', nil, [CStructDef.new('Foo', [Arg.new('x', nil, 'Int'.ident), Arg.new('y', nil, 'Int'.ident), Arg.new('z', nil, 'Int'.ident)])])
  it_parses "lib C; union Foo; end end", LibDef.new('C', nil, [CUnionDef.new('Foo')])
